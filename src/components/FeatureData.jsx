...
const FeatureData = (props) => {
  ...
  const { name, company, logo, _job, _job_,_id} = props.featureData
        ...
        <div className="card w-full h-96 mb-10 bg-base-100 shadow-2xl">
          ...
          <div className="card-body">
            ...
            <div className="card-actions">
              {/*<Link to='/viewDetail/:_id' className='default'>*/}</div><button onClick="" className='bg-blue-400 default text-center rounded-md px-4 py-2 mb-2 text-white fw-bold'>View Detail</button>
